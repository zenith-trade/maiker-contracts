...
impl<'a> TryFrom<&solana_program::account_info::AccountInfo<'a>> for UserPosition {
...
pub fn fetch_all_user_position(
    ...
    for i in 0..addresses.len() {
        ...
        let data = UserPosition::from_bytes(&account.data)?;
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountDeserialize for UserPosition {
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountSerialize for UserPosition {}

#[cfg(feature = "anchor")]
impl anchor_lang::Owner for UserPosition {
    fn owner() -> Pubkey {
...
impl anchor_lang::IdlBuild for UserPosition {}

#[cfg(feature = "anchor-idl-build")]
impl anchor_lang::Discriminator for UserPosition {
