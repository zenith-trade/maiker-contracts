...
pub struct InitializeReward {
    ...
    pub token_badge: Option<solana_program::pubkey::Pubkey>,
...
impl InitializeReward {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        if let Some(token_badge) = self.token_badge {
            accounts.push(solana_program::instruction::AccountMeta::new_readonly(
                token_badge,
                false,
            ));
...
pub struct InitializeRewardCpiAccounts<'a, 'b> {
    ...
    pub token_badge: Option<&'b solana_program::account_info::AccountInfo<'a>>,
...
impl<'a, 'b> InitializeRewardCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        if let Some(token_badge) = self.token_badge {
            account_infos.push(token_badge.clone());
        }
...
impl<'a, 'b> InitializeRewardCpiBuilder<'a, 'b> {
    ...
    pub fn token_badge(
        ...
        self.instruction.token_badge = token_badge;
        self
    }
    #[inline(always)]
    ...
    pub fn invoke_signed(
        ...
        let instruction = InitializeRewardCpi {
            ...
            token_badge: self.instruction.token_badge,
