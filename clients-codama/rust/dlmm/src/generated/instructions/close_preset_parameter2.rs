...
pub struct ClosePresetParameter2InstructionData {
    discriminator: [u8; 8],
}

impl ClosePresetParameter2InstructionData {
    pub fn new() -> Self {
        Self {
...
/// Instruction builder for `ClosePresetParameter2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` preset_parameter
...
///   2. `[writable]` rent_receiver
#[derive(Clone, Debug)]
pub struct ClosePresetParameter2CpiBuilder<'a, 'b> {
    instruction: Box<ClosePresetParameter2CpiBuilderInstruction<'a, 'b>>,
}
