...
impl SwapExactOut2 {
    pub fn instruction(
        &self,
        args: SwapExactOut2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&SwapExactOut2InstructionData::new()).unwrap();
...
pub struct SwapExactOut2InstructionData {
    discriminator: [u8; 8],
}

impl SwapExactOut2InstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for SwapExactOut2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapExactOut2InstructionArgs {
    pub max_in_amount: u64,
    pub out_amount: u64,
    pub remaining_accounts_info: RemainingAccountsInfo,
}

/// Instruction builder for `SwapExactOut2`.
///
/// ### Accounts:
///
///   0. `[writable]` lb_pair
...
pub struct SwapExactOut2Builder {
...
impl SwapExactOut2Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = SwapExactOut2InstructionArgs {
            max_in_amount: self
                .max_in_amount
                .clone()
...
/// `swap_exact_out2` CPI accounts.
pub struct SwapExactOut2CpiAccounts<'a, 'b> {
...
/// `swap_exact_out2` CPI instruction.
pub struct SwapExactOut2Cpi<'a, 'b> {
    ...
    pub __args: SwapExactOut2InstructionArgs,
}

impl<'a, 'b> SwapExactOut2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: SwapExactOut2CpiAccounts<'a, 'b>,
        args: SwapExactOut2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SwapExactOut2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` lb_pair
...
///   15. `[]` program
#[derive(Clone, Debug)]
pub struct SwapExactOut2CpiBuilder<'a, 'b> {
    instruction: Box<SwapExactOut2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SwapExactOut2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SwapExactOut2CpiBuilderInstruction {
            __program: program,
            lb_pair: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = SwapExactOut2Cpi {
...
#[derive(Clone, Debug)]
struct SwapExactOut2CpiBuilderInstruction<'a, 'b> {
