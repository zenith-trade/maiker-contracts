...
pub struct ClosePositionIfEmptyInstructionData {
    discriminator: [u8; 8],
}

impl ClosePositionIfEmptyInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for ClosePositionIfEmptyInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `ClosePositionIfEmpty`.
///
/// ### Accounts:
///
///   0. `[writable]` position
...
/// Instruction builder for `ClosePositionIfEmpty` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` position
...
///   4. `[]` program
#[derive(Clone, Debug)]
pub struct ClosePositionIfEmptyCpiBuilder<'a, 'b> {
    instruction: Box<ClosePositionIfEmptyCpiBuilderInstruction<'a, 'b>>,
}
