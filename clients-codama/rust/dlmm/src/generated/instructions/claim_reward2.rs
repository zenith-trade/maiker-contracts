...
impl ClaimReward2 {
    pub fn instruction(
        &self,
        args: ClaimReward2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&ClaimReward2InstructionData::new()).unwrap();
...
pub struct ClaimReward2InstructionData {
    discriminator: [u8; 8],
}

impl ClaimReward2InstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for ClaimReward2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ClaimReward2InstructionArgs {
...
/// Instruction builder for `ClaimReward2`.
///
/// ### Accounts:
///
///   0. `[writable]` lb_pair
...
pub struct ClaimReward2Builder {
...
impl ClaimReward2Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = ClaimReward2InstructionArgs {
...
/// `claim_reward2` CPI accounts.
pub struct ClaimReward2CpiAccounts<'a, 'b> {
...
/// `claim_reward2` CPI instruction.
pub struct ClaimReward2Cpi<'a, 'b> {
    ...
    pub __args: ClaimReward2InstructionArgs,
}

impl<'a, 'b> ClaimReward2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ClaimReward2CpiAccounts<'a, 'b>,
        args: ClaimReward2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ClaimReward2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` lb_pair
...
///   9. `[]` program
#[derive(Clone, Debug)]
pub struct ClaimReward2CpiBuilder<'a, 'b> {
    instruction: Box<ClaimReward2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ClaimReward2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ClaimReward2CpiBuilderInstruction {
            __program: program,
            lb_pair: None,
            position: None,
            sender: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ClaimReward2Cpi {
...
#[derive(Clone, Debug)]
struct ClaimReward2CpiBuilderInstruction<'a, 'b> {
