...
use crate::generated::types::CustomizableParams;
...
impl InitializeCustomizablePermissionlessLbPair2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data =
            borsh::to_vec(&InitializeCustomizablePermissionlessLbPair2InstructionData::new())
                .unwrap();
...
pub struct InitializeCustomizablePermissionlessLbPair2InstructionData {
    discriminator: [u8; 8],
}

impl InitializeCustomizablePermissionlessLbPair2InstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for InitializeCustomizablePermissionlessLbPair2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InitializeCustomizablePermissionlessLbPair2InstructionArgs {
    pub params: CustomizableParams,
}

/// Instruction builder for `InitializeCustomizablePermissionlessLbPair2`.
///
/// ### Accounts:
///
///   0. `[writable]` lb_pair
...
impl InitializeCustomizablePermissionlessLbPair2Builder {
    ...
    #[inline(always)]
    pub fn params(&mut self, params: CustomizableParams) -> &mut Self {
...
/// Instruction builder for `InitializeCustomizablePermissionlessLbPair2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` lb_pair
...
///   16. `[]` program
#[derive(Clone, Debug)]
pub struct InitializeCustomizablePermissionlessLbPair2CpiBuilder<'a, 'b> {
    instruction: Box<InitializeCustomizablePermissionlessLbPair2CpiBuilderInstruction<'a, 'b>>,
}
...
impl<'a, 'b> InitializeCustomizablePermissionlessLbPair2CpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(
        ...
        let instruction = InitializeCustomizablePermissionlessLbPair2Cpi {
