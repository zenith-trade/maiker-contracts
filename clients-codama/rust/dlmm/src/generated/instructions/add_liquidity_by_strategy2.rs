...
use crate::generated::types::LiquidityParameterByStrategy;
...
impl AddLiquidityByStrategy2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&AddLiquidityByStrategy2InstructionData::new()).unwrap();
...
pub struct AddLiquidityByStrategy2InstructionData {
    discriminator: [u8; 8],
}

impl AddLiquidityByStrategy2InstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for AddLiquidityByStrategy2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct AddLiquidityByStrategy2InstructionArgs {
    pub liquidity_parameter: LiquidityParameterByStrategy,
    pub remaining_accounts_info: RemainingAccountsInfo,
}

/// Instruction builder for `AddLiquidityByStrategy2`.
///
/// ### Accounts:
///
///   0. `[writable]` position
...
pub struct AddLiquidityByStrategy2Builder {
    ...
    liquidity_parameter: Option<LiquidityParameterByStrategy>,
    remaining_accounts_info: Option<RemainingAccountsInfo>,
    __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl AddLiquidityByStrategy2Builder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn liquidity_parameter(
        &mut self,
        liquidity_parameter: LiquidityParameterByStrategy,
    ) -> &mut Self {
        self.liquidity_parameter = Some(liquidity_parameter);
        self
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = AddLiquidityByStrategy2 {
        ...
        let args = AddLiquidityByStrategy2InstructionArgs {
            liquidity_parameter: self
                .liquidity_parameter
                .clone()
                .expect("liquidity_parameter is not set"),
...
/// `add_liquidity_by_strategy2` CPI accounts.
pub struct AddLiquidityByStrategy2CpiAccounts<'a, 'b> {
...
/// `add_liquidity_by_strategy2` CPI instruction.
pub struct AddLiquidityByStrategy2Cpi<'a, 'b> {
    ...
    pub __args: AddLiquidityByStrategy2InstructionArgs,
}

impl<'a, 'b> AddLiquidityByStrategy2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: AddLiquidityByStrategy2CpiAccounts<'a, 'b>,
        args: AddLiquidityByStrategy2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `AddLiquidityByStrategy2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` position
...
///   13. `[]` program
#[derive(Clone, Debug)]
pub struct AddLiquidityByStrategy2CpiBuilder<'a, 'b> {
    instruction: Box<AddLiquidityByStrategy2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddLiquidityByStrategy2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(AddLiquidityByStrategy2CpiBuilderInstruction {
            __program: program,
            position: None,
            lb_pair: None,
    ...
    pub fn liquidity_parameter(
        ...
        self.instruction.liquidity_parameter = Some(liquidity_parameter);
        self
    }
    #[inline(always)]
    pub fn remaining_accounts_info(
    ...
    pub fn invoke_signed(
        ...
        let instruction = AddLiquidityByStrategy2Cpi {
...
#[derive(Clone, Debug)]
struct AddLiquidityByStrategy2CpiBuilderInstruction<'a, 'b> {
