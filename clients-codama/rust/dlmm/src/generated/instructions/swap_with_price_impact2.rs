...
impl SwapWithPriceImpact2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&SwapWithPriceImpact2InstructionData::new()).unwrap();
...
pub struct SwapWithPriceImpact2InstructionData {
    discriminator: [u8; 8],
}

impl SwapWithPriceImpact2InstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for SwapWithPriceImpact2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapWithPriceImpact2InstructionArgs {
    pub amount_in: u64,
...
/// Instruction builder for `SwapWithPriceImpact2`.
///
/// ### Accounts:
///
///   0. `[writable]` lb_pair
...
/// Instruction builder for `SwapWithPriceImpact2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` lb_pair
...
///   15. `[]` program
#[derive(Clone, Debug)]
pub struct SwapWithPriceImpact2CpiBuilder<'a, 'b> {
    instruction: Box<SwapWithPriceImpact2CpiBuilderInstruction<'a, 'b>>,
}
...
impl<'a, 'b> SwapWithPriceImpact2CpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(
        ...
        let instruction = SwapWithPriceImpact2Cpi {
